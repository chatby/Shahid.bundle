...
chnurl ='http://shahid.mbc.net/ar/channel-browser/autoGeneratedContent/channelBrowserGrid~browse~-param-.sort-latest.pageNumber-%d.html'
...
chshow ='http://shahid.mbc.net/ar/channel/autoGeneratedContent/relatedShowListingDynamic~listing~-param-.ptype-channel.channelId-%s.sort-latest.pageNumber-%d.html'
chseries ='http://shahid.mbc.net/ar/channel/autoGeneratedContent/relatedSeriesListingDynamic~listing~-param-.ptype-channel.channelId-%s.sort-latest.pageNumber-%d.html'


url_series = 'http://shahid.mbc.net/ar/series/%s'
url_show = 'http://shahid.mbc.net/ar/show/%s'
url_channel = 'http://shahid.mbc.net/ar/channel/%s'
...
urlep2 = 'http://shahid.mbc.net/ar/channel/autoGeneratedContent/relatedShowListingDynamic~listing~-param-.ptype-channel.channelId-7890.sort-latest.pageNumber-0.html'
...
def ChannelId(SID,stype):
	...
	while (k < containernum) :
		...
		srs = map(lambda x: x.split('=')[1].split('/')[2:4], srs)
